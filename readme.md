...
biomasa/
├─ data/
│  ├─ csiro-biomass.zip           # (NO se sube a GitHub)
│  └─ csiro-biomass/              # contenido descomprimido (train.csv, test.csv, imágenes, etc.)
├─ import.py                      # script para descomprimir y cargar datos
├─ .gitignore
└─ readme.md
